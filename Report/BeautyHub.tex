...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{mockups/αναζήτηση.png}
    \caption{Αναζήτηση και επιλογή κομμωτηρίου}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{mockups/προβολή ραντεβου και κλεισιμο.png}
    \caption{Αίτηση ραντεβού}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{mockups/τροποποιηση απο πελάτη.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{mockups/στατιστικά.png}
