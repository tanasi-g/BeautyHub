...
\begin{titlepage}
    \begin{center}
        ...
        \begin{tabular}{l l l l}
            \large Εμμανουήλ Τσιόρβας & \large 1072622 & \color{customCodeBlue}\faEnvelope~up1072622@ac.upatras.gr \quad \color{customBlack} & \href{https://github.com/ManosTs}{\color{customCodeBlue}\faGithub~ManosTs} \\
            \large Αθανάσιος Γαβριήλ & \large 1093335 & \color{customCodeBlue}\faEnvelope~up1093335@ac.upatras.gr \quad \color{customBlack} & \href{https://github.com/tanasi-g}{\color{customCodeBlue}\faGithub~tanasi-g} \\
            \large Κωνσταντίνα - Μαρία Δεδεμάδη & \large 1093350 & \color{customCodeBlue}\faEnvelope~up1093350@ac.upatras.gr \quad \color{customBlack} & \href{https://github.com/Kon-d456}{\color{customCodeBlue}\faGithub~Kon-d456} \\
            \large Γεώργιος Καπατσούλιας & \large 1093377 & \color{customCodeBlue}\faEnvelope~up1093377@ac.upatras.gr \quad \color{customBlack} & \href{https://github.com/Georgekappa}{\color{customCodeBlue}\faGithub~Georgekappa} \\
            \large Αντώνιος Τσιπουλάκος & \large 1097450 & \color{customCodeBlue}\faEnvelope~up1097450@ac.upatras.gr \quad \color{customBlack} & \href{https://github.com/antoniosstsip}{\color{customCodeBlue}\faGithub~antoniosstsip} \\
...
Η πλατφόρμα ενσωματώνει έναν μηχανισμό αξιολόγησης δύο επιπέδων, προσφέροντας απόλυτη διαφάνεια στην ποιότητα των υπηρεσιών. Μετά από κάθε ραντεβού, οι πελάτες έχουν τη δυνατότητα να βαθμολογήσουν τόσο τη συνολική εμπειρία τους στο κομμωτήριο (χώρος, εξυπηρέτηση, καθαριότητα), όσο και τον hair expert που τους ανέλαβε (τεχνική κατάρτιση, επικοινωνία, αποτέλεσμα). 
\section{Κατανομή Προσπάθειας}

Στο πλαίσιο της παρούσας εργασίας, όλα τα μέλη της ομάδας συνέβαλαν ενεργά και με ίση προσπάθεια σε κάθε στάδιο και τμήμα του project. Η κατανομή των καθηκόντων πραγματοποιήθηκε με γνώμονα την ισότιμη συμμετοχή, ενώ κάθε μέλος αφιέρωσε τον απαραίτητο χρόνο και προσπάθεια. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/αναζήτηση.png}
    \caption{Αναζήτηση και επιλογή κομμωτηρίου}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/προβολη.png}
    \caption{Αίτηση ραντεβού}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/τροποποιηση απο πελάτη.png}
    \caption{Αίτηση τροποποίησης ραντεβού από πελάτη}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/διαχειριση ραντεβου.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/δημιουργια υπηρεσιας.png}
    \caption{Δημιουργία νέας υπηρεσίας}
\end{figure} 
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/διαχειριση αποθεματος.png}
    \caption{Διαχείριση αποθεμάτων}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../Mockup Screens/αξιολογηση.png}
    \caption{Αξιολόγηση υπηρεσιών και hair expert}
\end{figure}

\section{Final Version of UI}
\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/login.png}
        \captionof{figure}{Login page}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/signup.png}
        \captionof{figure}{Signup page}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/custp.png}
        \captionof{figure}{Customer page}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/αναζκομ.png}
        \captionof{figure}{Αναζήτηση κομμωτηρίου}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/κρατραντ.png}
        \captionof{figure}{Κράτηση Ραντεβού}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/στοιχραντ.png}
        \captionof{figure}{Στοιχεία Ραντεβού από πελάτη}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/ραντπροβ.png}
        \captionof{figure}{Προβολή των ραντεβού από πελάτη}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/eshopc.png}
        \captionof{figure}{E-shop πελάτη}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/καλαθι.png}
        \captionof{figure}{Καλάθι αγορών}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/παραγγ.png}
        \captionof{figure}{Παραγγελία πελάτη}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/πληρωμη.png}
        \captionof{figure}{Πληρωμή}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/ειδοπ.png}
        \captionof{figure}{Ειδοποίησεις πελάτη}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/αξιολ.png}
        \captionof{figure}{Αξιολογήσεις}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/κομσελ.png}
        \captionof{figure}{Αρχική σελίδα κομμωτή}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/στοιχραντκομ.png}
        \captionof{figure}{Στοιχεία ραντεβού από κομμωτή}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/επιβτροπ.png}
        \captionof{figure}{Επιβεβαίωση/Τροποποίηση ραντεβού}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/adminp.png}
        \captionof{figure}{Αρχική σελίδα διαχειριστή}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/προβυπηρ.png}
        \captionof{figure}{Προβολή υπηρεσιών}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/νεαυπηρ.png}
        \captionof{figure}{Νέα υπηρεσία}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../Final UI/eshopa.png}
        \captionof{figure}{E-shop διαχειριστή}
    \end{minipage}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{../Final UI/απογρφ.png}
    \caption{Απογραφή/Διαχείριση αποθέματος}
\end{figure}
...
\section{Περιγραφή}
\begin{itemize}
    \item User: Βασικός χρήστης του συστήματος με προσωπικά στοιχεία και στοιχεία σύνδεσης.
    \item Customer: Πελάτης που πραγματοποιεί κρατήσεις, παραγγελίες και αξιολογήσεις.
    \item Employee: Υπάλληλος του κομμωτηρίου που παρέχει υπηρεσίες και διαχειρίζεται εργασίες.
    \item Administrator: Διαχειριστής του κομμωτηρίου με αυξημένα δικαιώματα διαχείρισης.
    \item Salon: Το κομμωτήριο με τα στοιχεία επικοινωνίας και τις υπηρεσίες του.
    \item Service: Υπηρεσία που προσφέρεται από το κομμωτήριο (π.χ. κούρεμα, βαφή).
    \item Appointment: Προγραμματισμένο ραντεβού πελάτη για συγκεκριμένη υπηρεσία.
    \item Review: Αξιολόγηση πελάτη για ένα ραντεβού ή υπηρεσία.
    \item SalonReview: Αξιολόγηση πελάτη για το κομμωτήριο συνολικά.
    \item Notification: Ειδοποίηση που αποστέλλεται σε χρήστες για διάφορα γεγονότα.
    \item Cart: Καλάθι αγορών που περιέχει προϊόντα προς αγορά.
    \item CartLine: Γραμμή καλαθιού που αντιστοιχεί σε συγκεκριμένο προϊόν και ποσότητα.
    \item Product: Προϊόν που πωλείται από το κομμωτήριο.
    \item Order: Ολοκληρωμένη παραγγελία προϊόντων από πελάτη.
    \item OrderItem: Στοιχείο παραγγελίας που καταγράφει προϊόν, ποσότητα και τιμή.
    \item Payment: Πληρωμή που σχετίζεται με μια παραγγελία ή υπηρεσία.
    \item Inventory: Διαδικασία ή καταγραφή απογραφής αποθέματος προϊόντων.
    \item InventoryLine: Εγγραφή απογραφής για συγκεκριμένο προϊόν με πραγματική και αναμενόμενη ποσότητα.
\end{itemize}
\clearpage
\section{Διάγραμμα}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC8.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC9.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC10.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC11.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../Robustness Diagrams/UC12.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{classd.png}
    \caption{Class diagram για την εφαρμογή BeautyHub}
\end{figure}

\chapter{Project-code-v1.0}
Το αποθετήριο του έργου βρίσκεται στο GitHub και είναι δημόσιο. Μπορείτε να το βρείτε στον παρακάτω σύνδεσμο: https://github.com/tanasi-g/BeautyHub.
...
Το παρόν κεφάλαιο περιγράφει τις περιπτώσεις δοκιμών της εφαρμογής BeautyHub. Οι περιπτώσεις δοκιμών δημιουργήθηκαν από όλα τα μέλη.
Οι δοκιμές πραγματοποιήθηκαν με τη μέθοδο black box testing, όπου ελέγχεται η λειτουργικότητα της εφαρμογής με βάση τις εισόδους και τις αναμενόμενες εξόδους, χωρίς να λαμβάνεται υπόψη η εσωτερική δομή του κώδικα.
Το αρχείο κώδικα βρίσκεται στον φάκελο test.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../test/test_code.png}
    \caption{Απόσπασμα κώδικα test}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../test/test_res.png}
    \caption{ Αποτελέσματα του test }
\end{figure}
